...
| Ethernet3 | P2P_DC31_L2_LEAF_1_1_Ethernet2 | - | 10.255.255.2/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description P2P_DC31_L2_LEAF_1_1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.255.3 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65101
   ...
   neighbor 10.255.255.3 remote-as 65103
   neighbor 10.255.255.3 description DC31_L2_LEAF_1_1_Ethernet2
