...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.19.180.12/20 | 172.19.177.131 |
...
| --------- | --------------- | ------------ | --------- |
| DC31_L3_LEAVES_1 | Vlan4094 | 11.255.0.0 | Port-Channel7 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | L2_DC31_L2_LEAF_1_1_Ethernet2 | *trunk | *11-12,21-22,3401-3402 | *- | *- | 3 |
| Ethernet4 | SERVER_DC31_SERVER_1_Ethernet2 | *trunk | *11-12,21-22 | *4092 | *- | 4 |
| Ethernet7 | MLAG_DC31_L3_LEAF_1_1_Ethernet7 | *trunk | *- | *- | *MLAG | 7 |
| Ethernet8 | MLAG_DC31_L3_LEAF_1_1_Ethernet8 | *trunk | *- | *- | *MLAG | 7 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_DC31_SPINE_1_Ethernet2 | - | 10.255.255.5/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_DC31_SPINE_2_Ethernet2 | - | 10.255.255.7/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_DC31_SPINE_1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_DC31_SPINE_2_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description L2_DC31_L2_LEAF_1_1_Ethernet2
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description SERVER_DC31_SERVER_1_Ethernet2
   no shutdown
   channel-group 4 mode active
!
interface Ethernet7
   description MLAG_DC31_L3_LEAF_1_1_Ethernet7
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description MLAG_DC31_L3_LEAF_1_1_Ethernet8
   no shutdown
   channel-group 7 mode active
```
...
| Port-Channel7 | MLAG_DC31_L3_LEAF_1_1_Port-Channel7 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel7
   description MLAG_DC31_L3_LEAF_1_1_Port-Channel7
   no shutdown
   switchport mode trunk
...
| Vlan3009 |  VRF10  |  11.255.1.1/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  VRF11  |  11.255.1.1/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  11.255.1.1/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  11.255.0.1/31  |  -  |  -  |  -  |  -  |
...
!
interface Vxlan1
   description DC31_L3_LEAF_1_2_VTEP
...
| 11.255.1.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 11.255.1.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 11.255.1.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65101
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DC31_L3_LEAF_1_1
   ...
   neighbor 10.255.255.4 description DC31_SPINE_1_Ethernet2
   neighbor 10.255.255.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.6 remote-as 65100
   neighbor 10.255.255.6 description DC31_SPINE_2_Ethernet2
   neighbor 11.255.1.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 11.255.1.0 description DC31_L3_LEAF_1_1_Vlan4093
   ...
   vrf VRF10
      ...
      update wait-install
      neighbor 11.255.1.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 11.255.1.0 description DC31_L3_LEAF_1_1_Vlan3009
   ...
   vrf VRF11
      ...
      update wait-install
      neighbor 11.255.1.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 11.255.1.0 description DC31_L3_LEAF_1_1_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
