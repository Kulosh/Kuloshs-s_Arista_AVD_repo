...
| Ethernet3 | P2P_DC31_L2_LEAF_2_1_Ethernet1 | - | 10.255.255.4/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description P2P_DC31_L2_LEAF_2_1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.255.5 | 65104 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65102
   ...
   neighbor 10.255.255.5 remote-as 65104
   neighbor 10.255.255.5 description DC31_L2_LEAF_2_1_Ethernet1
